...
public class dynamic_background_handler : MonoBehaviour
{
    ...
    private void checa_estado_jogo()
    {
        ...
        case 1:
            ...
            nuvens_old.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(0, - 3.2f * 10.0f/phase_end);

            // Configurando as nuvens da base
            nuvens_new_background_1.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(0, - 0.6f);
            nuvens_new_background_2.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(0, - 1.2f);
            break;
        case 2:
            // Cor do ceu azul
            ...
            break;
        case 3:
            estrelas.GetComponent<Rigidbody2D>().linearVelocity = new Vector2(0, - 0.3f);
            break;
        default:
            break;
        }
