...
\usepackage{listings}                                                     % Code example formating
...
\usepackage{url}                                                 % Possibilita uso de hífen em links
...
% \let\@Vs@envwarn\@gobble% Remove environment renewal warnings. Todo 
\usepackage{silence}
...
\setlength\headheight{14.5pt}                                             % headheight length 
